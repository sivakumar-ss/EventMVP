...
import { Search, UserPlus, UserMinus, Users, CheckCircle, Zap, Shield, SearchCode } from 'lucide-react';
import toast from 'react-hot-toast';

export default function StudentNetwork() {
  const [activeTab, setActiveTab] = useState('explore'); // explore, followers, following
  const [students, setStudents] = useState([]);
  const [followers, setFollowers] = useState([]);
  const [following, setFollowing] = useState([]);
  const [summary, setSummary] = useState({ followersCount: 0, followingCount: 0 });
    ...
    <div className="flex">
      ...
      <div className="flex-1 lg:ml-64 p-6 lg:p-10">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="stat-card flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-extrabold text-gray-900 mt-1">
                  {summary.followersCount + summary.followingCount}
                </h3>
              </div>
          ...
          {/* Tab Selection */}
          <div className="flex border-b border-gray-300 mb-8 gap-6">
            <button
                  ...
                  students.map((student) => (
                    ...
                    >
                      <div>
                        ...
                        {/* Network Stats */}
                        <div className="flex gap-6 py-3 border-y border-gray-200 my-4">
